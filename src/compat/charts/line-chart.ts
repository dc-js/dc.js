...
export class LineChart extends StackMixinExt(CoordinateGridMixinExt(ColorMixinExt(MarginMixinExt(BaseMixinExt((LineChartNeo)))))) {
    constructor (parent: ChartParentType, chartGroup: ChartGroupType) {
        super(parent, chartGroup);
    }
}

export const lineChart = (parent: ChartParentType, chartGroup: ChartGroupType) => new LineChart(parent, chartGroup);
