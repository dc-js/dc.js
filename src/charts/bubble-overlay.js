        ...
        this._points.forEach(point => {
            ...
            if (circle.empty()) {
                circle = nodeG.append('circle')
                    ...
                    .on('click', config._d3compat.eventHandler(d => this.onClick(d)));
            }
    ...
    debug (flag) {
        if (flag) {
            ...
            debugG
                ...
                .on('mousemove', config._d3compat.eventHandler((d, evt) => {
                    const position = config._d3compat.pointer(evt, debugG.node());
