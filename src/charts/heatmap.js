...
export class HeatMap extends ColorMixin(MarginMixin) {
    ...
    _doRedraw () {
        ...
        gEnter.append('rect')
            ...
            .on('click', config._d3compat.eventHandler(this.boxOnClick()));
        ...
        gColsText = gColsText
            ...
            .attr('dy', 12)
            .on('click', config._d3compat.eventHandler(this.xAxisOnClick()))
            .text(this.colsLabel())
            .merge(gColsText);
        ...
        gRowsText = gRowsText
            ...
            .attr('dy', 6)
            .on('click', config._d3compat.eventHandler(this.yAxisOnClick()))
            .text(this.rowsLabel())
            .merge(gRowsText);
