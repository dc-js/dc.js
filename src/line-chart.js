...
dc.lineChart = function (parent, chartGroup) {
        ...
        if (!_chart.brushOn()) {
            ...
            layers.each(function (d, layerIndex) {
                ...
                dots.enter()
                    ...
                    .attr("fill", _chart.getColor) //function() {return _chart.colorCalculator()(layerIndex);})
    ...
    **/
    ...
    //Match color and dash-array for line, color and area for area plot. add class "deselected"
    _chart.legendClick = function (d) {
        _chart.selectAll('.chart-body').selectAll('path').filter(function () {
            return (d3.select(this).attr('fill') == d.color && d3.select(this).attr('stroke-dasharray') == d.dashstyle.join(',') ||
                    d3.select(this).attr('fill') == d.color && d3.select(this).classed("area")  );
        }).classed('deselected', function () {
