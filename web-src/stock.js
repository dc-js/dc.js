...
chartGroup.filterStorage.onFilterChange('debug', params => {
    console.log(`Chart Ids: [${params.chartIds}] - filters: [${params.filters}]`);
    console.log(`Filter state: ${JSON.stringify(chartGroup.filterStorage.serialize())}`);
});
