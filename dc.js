(function (global, factory) {
    ...
    (global = global || self, factory(global.dc = {}, global.d3));
    ...
    */
     ...
     * @default false
     */
    const disableTransitions = false;
    ...
    const afterTransition = function (transition, callback) {
    ...
    const override = function (obj, functionName, newFunction) {
     ...
     */
    const baseMixin = function (_chart) {
     ...
     */
    const colorMixin = function (_chart) {
     ...
     */
    const bubbleMixin = function (_chart) {
     ...
     */
    const bubbleOverlay = function (parent, chartGroup) {
     ...
     */
    const marginMixin = function (_chart) {
     ...
     */
    const coordinateGridMixin = function (_chart) {
        ...
        function prepareXAxis (g, render) {
            ...
            var xdom = _x.domain();
            if (render || !utils.arraysEqual(_lastXDomain, xdom)) {
                _chart.rescale();
            }
            _lastXDomain = xdom;
        ...
        _chart._brushing = function () {
            ...
            var rangedFilter = _chart.brushIsEmpty(brushSelection) ? null : filters.RangedFilter(brushSelection[0], brushSelection[1]);
        ...
        function zoomHandler (newDomain, noRaiseEvents) {
            ...
            if (!noRaiseEvents) {
                if (_rangeChart && !utils.arraysEqual(_chart.filter(), _rangeChart.filter())) {
                    events.trigger(function () {
        ...
        _chart.refocused = function () {
            return !utils.arraysEqual(_chart.x().domain(), _xOriginalDomain);
        };
        ...
        _chart.focusChart = function (c) {
            ...
            _chart.on('filtered.dcjs-range-chart', function (chart) {
                ...
                } else if (!utils.arraysEqual(chart.filter(), _focusChart.filter())) {
                    events.trigger(function () {
     ...
     * @returns {dc.capMixin}
     */
    const capMixin = function (_chart) {
     ...
     */
    const stackMixin = function (_chart) {
     ...
     * @returns {dc.barChart}
     */
    const barChart = function (parent, chartGroup) {
        var MIN_BAR_WIDTH = 1;
     ...
     * @returns {dc.boxPlot}
     */
    const boxPlot = function (parent, chartGroup) {
     ...
     */
    const bubbleChart = function (parent, chartGroup) {
    ...
    const cboxMenu = function (parent, chartGroup) {
     ...
     */
    const compositeChart = function (parent, chartGroup) {
        ...
        override(_chart, 'xAxisMin', function () {
            return utils.subtract(d3.min(getAllXAxisMinFromChildCharts()), _chart.xAxisPadding(), _chart.xAxisPaddingUnit());
        });
        ...
        override(_chart, 'xAxisMax', function () {
            return utils.add(d3.max(getAllXAxisMaxFromChildCharts()), _chart.xAxisPadding(), _chart.xAxisPaddingUnit());
        });
     ...
     */
    const dataCount = function (parent, chartGroup) {
     ...
     * @returns {dc.dataGrid}
     */
    const dataGrid = function (parent, chartGroup) {
     ...
     */
    const dataTable = function (parent, chartGroup) {
     ...
     */
    const geoChoroplethChart = function (parent, chartGroup) {
     ...
     * @returns {dc.heatMap}
     */
    const heatMap = function (parent, chartGroup) {
     ...
     */
    const lineChart = function (parent, chartGroup) {
     ...
     */
    const numberDisplay = function (parent, chartGroup) {
     ...
     * @returns {dc.pieChart}
     */
    const pieChart = function (parent, chartGroup) {
     ...
     * @returns {dc.rowChart}
     */
    const rowChart = function (parent, chartGroup) {
     ...
     */
    const scatterPlot = function (parent, chartGroup) {
        var _chart = coordinateGridMixin({});
     ...
     * @returns {selectMenu}
     **/
    const selectMenu = function (parent, chartGroup) {
        ...
        _chart.size = logger.deprecate(_chart.numberVisible, 'selectMenu.size is ambiguous - use numberVisible instead');
     ...
     */
    const seriesChart = function (parent, chartGroup) {
     ...
     **/
    const sunburstChart = function (parent, chartGroup) {
        var DEFAULT_MIN_ANGLE_FOR_LABEL = 0.5;
    ...
    const textFilterWidget = function (parent, chartGroup) {
    ...
    exports.abstractBubbleChart = bubbleMixin;
    exports.afterTransition = afterTransition;
    exports.barChart = barChart;
    exports.baseChart = baseMixin;
    ...
    exports.marginable = marginMixin;
    ...
    exports.stackableChart = stackMixin;
