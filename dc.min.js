...
});return a.utils.subtract(b,e.yAxisPadding())},e.yAxisMax=function(){var b=d3.max(e.data(),function(a){return d3.max(e.valueAccessor()(a))});return a.utils.add(b,e.yAxisPadding())},e.anchor(b,c)},a}();
