describe('dc.htmlLegend', function () {
  ...
  function legendItem(n) {
    return d3.select(legend.selectAll('table.dc-legend tr.dc-legend-item')[0][n]);
  }
  function legendLabel(n) {
    return d3.select(legend.selectAll('table.dc-legend tr.dc-legend-item td.dc-legend-item-label')[0][n]);
  }
