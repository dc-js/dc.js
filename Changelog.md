...
* Tell browserify the correct entry point `browser: dc.js`, so it won't try to bundle jsdom etc ([#1005](https://github.com/dc-js/dc.js/issues/1005) / ([#1062](https://github.com/dc-js/dc.js/pull/1062))
